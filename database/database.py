...
class DataBase:
    def __init__(self) -> None:
        ...
        self.__connection_string = f'mongodb+srv://schoolsystem:zhxu6CF_bquBRQZ@schoolsystem.uxif63l.mongodb.net/?retryWrites=true&w=majority&appName=schoolsystem'
